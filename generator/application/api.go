...
var file_api_api_proto_rawDesc = []byte{
	...
	0x01, 0x30, 0x01, 0x32, 0x3d, 0x0a, 0x0f, 0x47, 0x46, 0x43, 0x50, 0x44, 0x65, 0x6d, 0x6f, 0x53,
...
var file_api_api_proto_depIdxs = []int32{
	...
	0, // 2: api.GFCPDemoService.SayHello:input_type -> api.HelloRequest
	1, // 3: api.Greeter.SayHello:output_type -> api.User
	1, // 4: api.Greeter.SayHelloStream:output_type -> api.User
	1, // 5: api.GFCPDemoService.SayHello:output_type -> api.User
...
// GFCPDemoServiceClient is the client API for GFCPDemoService service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream.
type GFCPDemoServiceClient interface {
	// Sends a greeting
	SayHello(ctx context.Context, in *HelloRequest, opts ...grpc_go.CallOption) (*User, common.ErrorWithAttachment)
}

type gFCPDemoServiceClient struct {
	cc *triple.TripleConn
}

type GFCPDemoServiceClientImpl struct {
	SayHello func(ctx context.Context, in *HelloRequest) (*User, error)
}

func (c *GFCPDemoServiceClientImpl) GetDubboStub(cc *triple.TripleConn) GFCPDemoServiceClient {
	return NewGFCPDemoServiceClient(cc)
}

func (c *GFCPDemoServiceClientImpl) XXX_InterfaceName() string {
	return "api.GFCPDemoService"
}

func NewGFCPDemoServiceClient(cc *triple.TripleConn) GFCPDemoServiceClient {
	return &gFCPDemoServiceClient{cc}
}

func (c *gFCPDemoServiceClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc_go.CallOption) (*User, common.ErrorWithAttachment) {
	out := new(User)
	interfaceKey := ctx.Value(constant.InterfaceKey).(string)
	return out, c.cc.Invoke(ctx, "/"+interfaceKey+"/SayHello", in, out)
}

// GFCPDemoServiceServer is the server API for GFCPDemoService service.
// All implementations must embed UnimplementedGFCPDemoServiceServer
// for forward compatibility
type GFCPDemoServiceServer interface {
	// Sends a greeting
	SayHello(context.Context, *HelloRequest) (*User, error)
	mustEmbedUnimplementedGFCPDemoServiceServer()
}

// UnimplementedGFCPDemoServiceServer must be embedded to have forward compatible implementations.
type UnimplementedGFCPDemoServiceServer struct {
	proxyImpl protocol.Invoker
}

func (UnimplementedGFCPDemoServiceServer) SayHello(context.Context, *HelloRequest) (*User, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SayHello not implemented")
}
func (s *UnimplementedGFCPDemoServiceServer) XXX_SetProxyImpl(impl protocol.Invoker) {
	s.proxyImpl = impl
}

func (s *UnimplementedGFCPDemoServiceServer) XXX_GetProxyImpl() protocol.Invoker {
	return s.proxyImpl
}

func (s *UnimplementedGFCPDemoServiceServer) XXX_ServiceDesc() *grpc_go.ServiceDesc {
	return &GFCPDemoService_ServiceDesc
}
func (s *UnimplementedGFCPDemoServiceServer) XXX_InterfaceName() string {
	return "api.GFCPDemoService"
}

func (UnimplementedGFCPDemoServiceServer) mustEmbedUnimplementedGFCPDemoServiceServer() {}

// UnsafeGFCPDemoServiceServer may be embedded to opt out of forward compatibility for this service.
// Use of this interface is not recommended, as added methods to GFCPDemoServiceServer will
// result in compilation errors.
type UnsafeGFCPDemoServiceServer interface {
	mustEmbedUnimplementedGFCPDemoServiceServer()
}

func RegisterGFCPDemoServiceServer(s grpc_go.ServiceRegistrar, srv GFCPDemoServiceServer) {
	s.RegisterService(&GFCPDemoService_ServiceDesc, srv)
}

func _GFCPDemoService_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc_go.UnaryServerInterceptor) (interface{}, error) {
	in := new(HelloRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
...
// GFCPDemoService_ServiceDesc is the grpc_go.ServiceDesc for GFCPDemoService service.
// It's only intended for direct use with grpc_go.RegisterService,
// and not to be introspected or modified (even as a copy)
var GFCPDemoService_ServiceDesc = grpc_go.ServiceDesc{
	ServiceName: "api.GFCPDemoService",
	HandlerType: (*GFCPDemoServiceServer)(nil),
	Methods: []grpc_go.MethodDesc{
		{
			MethodName: "SayHello",
			Handler:    _GFCPDemoService_SayHello_Handler,
		},
	},
	Streams:  []grpc_go.StreamDesc{},
	Metadata: "api/api.proto",
